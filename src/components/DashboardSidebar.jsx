...
const DashboardSidebar = () => {
  ...
  const adminMenu = [
        ...
        { key: "events", label: "Events", icon: FaCalendarAlt, href:"/dashboard/events" },
        { key: "transactions", label: "Transactions", icon: FaHistory, href:"/dashboard/transactions" },    
  ]
  ...
  return (
    <div>
      <aside className='w-64 h-screen border-r border-white/7'>
